...
class TestQuestionsAboutImportant:
    ...
    def test_click_to_what_is_the_price(self, driver):
    ...
    @allure.description('Ожидаем, что раскроется div и отобразится ответ')
    def test_click_to_several_scooters(self, driver):
        questions_about_important = QuestionsAboutImportant(driver)
        questions_about_important.scroll_questions_about_important_block()
    ...
    @allure.description('Ожидаем, что раскроется div и отобразится ответ')
    def test_click_to_time_of_rent(self, driver):
        questions_about_important = QuestionsAboutImportant(driver)
        questions_about_important.scroll_questions_about_important_block()
    ...
    @allure.description('Ожидаем, что раскроется div и отобразится ответ')
    def test_click_to_order_today(self, driver):
        questions_about_important = QuestionsAboutImportant(driver)
        questions_about_important.scroll_questions_about_important_block()
    ...
    @allure.description('Ожидаем, что раскроется div и отобразится ответ')
    def test_click_to_extend_or_return_order(self, driver):
        questions_about_important = QuestionsAboutImportant(driver)
        questions_about_important.scroll_questions_about_important_block()
    ...
    @allure.description('Ожидаем, что раскроется div и отобразится ответ')
    def test_click_to_charger(self, driver):
        questions_about_important = QuestionsAboutImportant(driver)
        questions_about_important.scroll_questions_about_important_block()
    ...
    @allure.description('Ожидаем, что раскроется div и отобразится ответ')
    def test_click_cancel_order(self, driver):
        questions_about_important = QuestionsAboutImportant(driver)
        questions_about_important.scroll_questions_about_important_block()
    ...
    @allure.description('Ожидаем, что раскроется div и отобразится ответ')
    def test_click_outside_mkad(self, driver):
        questions_about_important = QuestionsAboutImportant(driver)
        questions_about_important.scroll_questions_about_important_block()
